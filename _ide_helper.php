...
namespace willvincent\Feeds\Facades { 
    ...
    class FeedsFacade {
         ...
         * @static 
         */ 
        public static function make($feed_url = array(), $limit = 0, $force_feed = false, $options = null)
        {
            return \willvincent\Feeds\FeedsFactory::make($feed_url, $limit, $force_feed, $options);
        }
