...
namespace App\Facades {
    ...
    class RssUtil
    {
        ...
        {
            /** @var \App\Services\RssUtilService $instance */
            return $instance->RssProsessing($user);
        }
    }
}
...
namespace willvincent\Feeds\Facades {
    ...
    class FeedsFacade
    {
         ...
         * @static
         */
        public static function make($feedUrl = [], $limit = 0, $forceFeed = false, $options = null)
        {
            /** @var \willvincent\Feeds\FeedsFactory $instance */
            return $instance->make($feedUrl, $limit, $forceFeed, $options);
        }
    }
}
